export default {
    ...
    status: "Ongoing",
    rate: 4,
    // tslint:disable-next-line:max-line-length // Emulate API from server
    ...
    pages: 12,
    cover_api: "https://hexschool.github.io/THE_F2E_Design/week5-comic%20viewer/assets/comic%20cover.png",
};
